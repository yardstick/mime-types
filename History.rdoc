...
* API Changes (MIME::Type):
  * Added MIME::Type#xrefs and MIME::Type#xref_urls that have better handling
    of types of reference information. In a future release, both
    MIME::Type#references and MIME::Type#urls will be marked deprecated in
    favour of MIME::Type#xrefs and MIME::Type#xref_urls.
* New or Updated MIME Types:
  * Most MIME types have had some metadata updates due to the change in the
  ...
  * Added:
    * application/emotionml\+xml, application/ODX, application/prs.hpub\+zip,
      ...
      application/vnd.openeye.oeb, application/vnd.tcpdump.pcap, audio/amr-wb,
      model/x3d\+xml, model/x3d-vrml
